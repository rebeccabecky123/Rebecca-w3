            ...
            >
              <div className="relative h-full">
                ...
                <div className="relative h-full bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden">
                  <div className="h-48 bg-gradient-to-br from-blue-500 to-indigo-600 relative overflow-hidden group-hover:scale-105 transition-transform duration-500">
                  ...
                  <div className="p-6">
                    ...
                    <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                      <a 
                        href="#" 
                        className="inline-flex items-center text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300 group-hover:translate-x-2 transition-all duration-300"
                      >
                        View Details
